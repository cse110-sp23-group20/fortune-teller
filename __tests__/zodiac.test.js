...
describe('Basic user flow for Website', () => {
    ...
    beforeAll(async () => { 
      await page.goto('https://cse110-sp23-group20.github.io/fortune-teller/source/Zodiac_compatibility/');
    });
      ...
      it('should perform a user interaction and verify the result', async () => {
        ...
        const pairingHeader = await page.$eval('#pairing', (element) => element.textContent);
